...
const AdminOverviewPage = () => (
  <div className="space-y-6">
    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <StatCard title="Total Users" value={62} icon={Users} trend={{ value: 8, positive: true }} />
      <StatCard title="Active Today" value={48} icon={UserCheck} variant="success" />
      <StatCard title="Avg Hours Today" value="7.8h" icon={Clock} />
      <StatCard title="Monthly Trend" value="+12%" icon={TrendingUp} variant="info" />
    </div>
